...
<div class="row" id="AddPageForm">
	<div class="col-lg-12 col-md-12">
		<div class="card custom-card">
			<div class="card-body">
				<div>
					<h3 class="card-title mb-1">افزودن برگه</h3>
				</div>
				<form  action="{{ route('page-create-post') }}" method="post" class="form-group">
                @csrf
				<div class="row">
					<div class="col-md-6">
				...
				<button type="submit" class="btn btn-main-primary">ایجاد برگه</button>
